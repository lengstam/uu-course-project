...
def data_saving(
    ...
    if year == 2020:
        return pd.DataFrame({'Biogas (CH4) [mol/h]': np.zeros(8784), 'Biogas (CO2) [mol/h]': np.zeros(8784), 'H2 demand [mol/h]': np.zeros(8784), 'AEF emissions [gCO$_2$/kWh]': np.zeros(8784), 'AEF emissions [gCO$_2$/kWh]': np.zeros(8784), 'Elspot [€/MWh]': np.zeros(8784), 'Elz dispatch [kWh/h]': np.zeros(8784), \
                             'System dispatch [kWh/h]': np.zeros(8784), 'Meth el [kWh/h]': np.zeros(8784), 'Biogas comp [kWh/h]': np.zeros(8784), 'Standby el. [kWh/h]': np.zeros(8784), 'Elz cold start': np.zeros(8784), 'Grid use [kWh/h]': np.zeros(8784), 'Wind use [kWh/h]': np.zeros(8784), 'Wind gen [kWh/h]': np.zeros(8784), \
                                 'PV use [kWh/h]': np.zeros(8784), 'PV gen [kWh/h]': np.zeros(8784), 'Battery state [%]': np.zeros(8784), 'Battery discharging [kWh/h]': np.zeros(8784), 'Stack efficiency [%]': np.zeros(8784), 'System efficiency [%]': np.zeros(8784), \
                                     'H2 production [kg/h]': np.zeros(8784), 'Unmet demand [kgH2/h]': np.zeros(8784), 'H2 to storage [mol/h]': np.zeros(8784), 'H2 from storage [mol/h]': np.zeros(8784), 'H2 storage [%]': np.zeros(8784), 'H2 to meth [mol/h]': np.zeros(8784), 'Meth CH4 in [mol/h]': np.zeros(8784), 'Meth CO2 in [mol/h]': np.zeros(8784), \
        ...
        return pd.DataFrame({'Biogas (CH4) [mol/h]': np.zeros(8760), 'Biogas (CO2) [mol/h]': np.zeros(8760), 'H2 demand [mol/h]': np.zeros(8760), 'AEF emissions [gCO$_2$/kWh]': np.zeros(8760), 'AEF emissions [gCO$_2$/kWh]': np.zeros(8760), 'Elspot [€/MWh]': np.zeros(8760), 'Elz dispatch [kWh/h]': np.zeros(8760), \
                             'System dispatch [kWh/h]': np.zeros(8760), 'Meth el [kWh/h]': np.zeros(8760), 'Biogas comp [kWh/h]': np.zeros(8760), 'Standby el. [kWh/h]': np.zeros(8760), 'Elz cold start': np.zeros(8760), 'Grid use [kWh/h]': np.zeros(8760), 'Wind use [kWh/h]': np.zeros(8760), 'Wind gen [kWh/h]': np.zeros(8760), \
                                 'PV use [kWh/h]': np.zeros(8760), 'PV gen [kWh/h]': np.zeros(8760), 'Battery state [%]': np.zeros(8760), 'Battery discharging [kWh/h]': np.zeros(8760), 'Stack efficiency [%]': np.zeros(8760), 'System efficiency [%]': np.zeros(8760), \
                                     'H2 production [kg/h]': np.zeros(8760), 'Unmet demand [kgH2/h]': np.zeros(8760), 'H2 to storage [mol/h]': np.zeros(8760), 'H2 from storage [mol/h]': np.zeros(8760), 'H2 storage [%]': np.zeros(8760), 'H2 to meth [mol/h]': np.zeros(8760), 'Meth CH4 in [mol/h]': np.zeros(8760), 'Meth CO2 in [mol/h]': np.zeros(8760), \
